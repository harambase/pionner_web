<template>
  <div class="animated fadeIn">
    ...
    <b-card
      ...
      footer-tag="footer">
      <div slot="header">
        <i className="fa fa-align-justify"></i><strong>入学基本信息</strong>
      </div>
      <b-row>
        <b-col md="2" class="my-1">
          <label class="col-sm-12 control-label">*入学名:</label>
        </b-col>
        <b-col md="3" class="my-1">
      ...
      <b-row>
        ...
        <b-col md="3" class="my-1">
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" value="入学" id="course" :disabled="tempCourse.status!=='0'"
                   :class="{'custom-control-input': true, 'is-invalid': errors.has('section')}"
                   name="section" v-model="course.section" v-validate="'required'">
            <label class="custom-control-label" for="course">入学</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" value="预约入学" id="app" :disabled="tempCourse.status!=='0'"
                   :class="{'custom-control-input': true, 'is-invalid': errors.has('section')}"
                   name="section" v-model="course.section" v-validate="'required'">
            <label class="custom-control-label" for="app">预约入学</label>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
      ...
      <div slot="footer">
        <i className="fa fa-align-justify"></i><strong>*为必填！ 注意，如果上课时间不是重复时间段，请再创建一个新入学，命名为 XX入学
    ...
    <b-card
      ...
      <b-row>
        ...
        <b-col md="2">
          <label class="control-label">预修入学（可多选，可不选）:</label>
        </b-col>
        <b-col md="3">
      ...
      <div slot="footer">
        <i className="fa fa-align-justify"></i><strong>对于一节课有多个老师的话，请在此处仅填写主要的负责老师，并在备注中写出参与入学的老师名字。</strong>
      </div>
    </b-card>
    <b-card
      header-tag="header"
      ...
      <b-row v-if="!showDocument">
        <b-col md="2" class="my-1">
          <label class="col-sm-12 control-label">上传入学大纲:</label>
        </b-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        contractRange: [new Date(2016, 9, 10, 9, 0), new Date(2016, 9, 10, 11, 0)],
        courseDate: [],
        courseDay: [],
        showDocument: false,
        confirm: false,
    ...
    methods: {
      ...
      prepare() {
        ...
        this.course.startTime = date2Str(this.contractRange[0], "hh:mm:ss");
        this.course.endTime = date2Str(this.contractRange[1], "hh:mm:ss");
